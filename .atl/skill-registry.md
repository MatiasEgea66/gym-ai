...
- /Users/matiasegea/.claude/skills
...
### branch-pr
- Path: /Users/matiasegea/.claude/skills/branch-pr/SKILL.md
...
### browser-automation
- Path: /Users/matiasegea/.claude/skills/browser-automation/SKILL.md
- Trigger: Ayuda a escribir scripts de automatizacion de navegador con Playwright, Puppeteer o Selenium. Genera codigo para scraping, testing E2E y automatizacion de flujos web.
- Rules:
...
### chained-pr
- Path: /Users/matiasegea/.claude/skills/chained-pr/SKILL.md
...
- Path: /Users/matiasegea/.claude/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /Users/matiasegea/.claude/skills/comment-writer/SKILL.md
...
### composio
- Path: /Users/matiasegea/.claude/skills/composio/SKILL.md
- Trigger: Integra y usa herramientas de Composio en agentes de IA. Ayuda a conectar APIs externas (GitHub, Gmail, Slack, Notion, etc.) a agentes Claude o LangChain usando el SDK de Composio.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### document-skills
- Path: /Users/matiasegea/.claude/skills/document-skills/SKILL.md
- Trigger: Lista, describe y ayuda a gestionar todas las skills instaladas en Claude Code. Muestra que skills existen, que hacen y como invocarlas.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### frontend-design
- Path: /Users/matiasegea/.claude/skills/frontend-design/SKILL.md
- Trigger: Disenha e implementa interfaces de usuario modernas con React, Tailwind y principios de UI/UX. Genera componentes accesibles, responsivos y visualmente consistentes.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: /Users/matiasegea/.claude/skills/go-testing/SKILL.md
...
### issue-creation
- Path: /Users/matiasegea/.claude/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /Users/matiasegea/.claude/skills/judgment-day/SKILL.md
...
- Path: /Users/matiasegea/.claude/skills/remotion-best-practices/SKILL.md
- Trigger: Aplica best practices de Remotion para crear videos programaticos con React. Cubre composiciones, timing, animaciones, renders y optimizacion.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /Users/matiasegea/.claude/skills/skill-creator/SKILL.md
...
### superpowers
- Path: /Users/matiasegea/.claude/skills/superpowers/SKILL.md
- Trigger: Activa modo experto maximo. Claude opera con maxima profundidad tecnica, cero filtros de simplificacion, respuestas densas y accionables para usuarios avanzados.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /Users/matiasegea/.claude/skills/work-unit-commits/SKILL.md
